...
`/export` does not run an export from inside your AI agent — bulk data export
...
- For sharing curated selections of content from inside your AI agent, use the
...
clarify that the in-agent path is `save_to_collection` + the returned
